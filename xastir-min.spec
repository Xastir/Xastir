...
%build
./bootstrap.sh
%configure --without-ax25 --without-festival --without-gpsman --with-internal-shapelib --without-libproj --without-geotiff --without-gdal --without-pcre --without-dbfawk --without-map-cache
make
